...
s3_image_path = Pathname.new("22.png") 
...
image.write(image_path.gsub("png","jpg")) # { self.quality = ARGV[0].to_i }

# Resize image to maxium dimensions
image.resize_to_fit!(250)

# Write image to file system
image.write(thumb_path.gsub("png","jpg")) # { self.quality = ARGV[0].to_i }
